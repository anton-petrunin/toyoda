...
\hypersetup{pdftitle={5-point CAT(0) spaces after  Tetsu Toyoda},
...
\nofootnote{\textbf{Keywords:} CAT(0), finite metric space, comparison inequality, Alexandrov comparison.}
...
%\parbf{Conflict of interest.} Authors state no conflict of interest.

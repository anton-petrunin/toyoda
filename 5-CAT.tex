...
\hypersetup{pdftitle={5 points in CAT(0) spaces after  Tetsu Toyoda},pdfauthor={Nina Lebedeva and Anton Petrunin}}
...
The $C_4$-comparison (for the 4-cycle left side of the diagram) defines $\CAT(0)$ comparison.
\begin{figure}[h!]
\vskip-0mm
\centering
\includegraphics{mppics/pic-30}
\end{figure}
The $O_3$-comparison (for the octahedron graph right side of the diagram) defines another comparison.

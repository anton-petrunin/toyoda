...
In this section we mostly review results of Anatolii Milka \cite{milka}.
...
equivalently if the Minkowski sum $\{p\}+C^+$ does not intersect~$K$.
...
\parit{Proof.}
We can assume that $W$ is nondegenerate; that is, after linear change of coordinates it is the standard form on $\RR^{3,1}$.
If not, then there is a $W$-preserving projection of the whole picture to a $W$-nondegenerate subspace; apply this projection and note that this subspace is isometric a subspace of $\RR^{3,1}$.

Choose a strictly spacelike hyperplane $\Pi$.
Assume $D$ is a smooth convex spacelike disc in $\RR^{3,1}$
that lies under $\Pi$ and has its boundary on $\Pi$.
By Gauss formula, $D$ has nonpositive sectional curvature.
Furhter, by Liebermnan's lemma \cite[Theorem~3]{milka}, $D$ has convex boundary.
Therefore Cartan--Hadamard theorem implies that that $D$ is $\CAT(0)$.

Now suppose $D_n$ is a sequence of smooth discs of the described type that converges to a (possibly nonsmooth) disc $D$.
Note that the metric on $D_n$ converges to a pseudometric on $D$ that induced by $W$.
...
Note that every maximal lightlike segment in $D$ starts at its interior point and goes to boundary.
Consider the map $\iota\:D\to D$ that sends each maximal lightlike segment to its starting point.
Convexity of $D$ implies that $\iota$ is length-nonincreasing.
It follows that the $D'$ is isometric to the image of $\iota$ with the metric induced by~$W$.
...
Now consider the Minkowski sum $K^-=K+C^+$;
...
By the lemma every shortest path in $\Sigma^-$ between $p$ and $q$ has to lie on $\Pi$;

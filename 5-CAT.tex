...
If not, then there is a $W$-preserving projection of the whole picture to a  nondegenerate subspace; it remains to note that this subspace is isometric a subspace of $\RR^{3,1}$.
...
If a part $Q$ of $S$ that lies under a spacelike hyperplane $\Pi$ is compact, then $Q$ is convex in $S$;

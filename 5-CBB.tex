...
It can be used to show that any 4-point space satisfying the nonnegative-curvature comparison
admits an embedding into a product of a circle and the Euclidean space.

Similarly any 4-point space satisfying the nonpositive-curvature comparison admits an embedding into a product of a tripod and the Euclidean space.

These two results are analogous to Wald's theorem mentioned above;
they were obtained in an unpublished note by the first author and Vladimir Zolotov.
...
Interesting classes of spaces for nonpositive curvature would be product of trees and Euclidean buildings.

...
The construction of the facets of $V$ implies that for each ellipsoid has a tangent plane that contains all the ellipsoids on one side --- these planes are the perpendicular bisectors to $[\tilde s\tilde q]$ and $[\tilde s\tilde q_i]$ for all $i$.
...
Note that in this case $x_1$-plane cannot be $x_2$-plane and the other way around.
